...
export default function Footer() {
  ...
  const services = [
    { name: "Web Development", path: "/webdesigner/web-development-IT-company-in-erode" },
    { name: "App Development", path: "/appdeveloper/app-development-IT-company-in-erode" },
    { name: "Graphic Design", path: "/graphicdesigner/graphic-design-IT-company-in-erode" },
    ...
    { name: "Digital Marketing", path: "/digitalmarketer/digital-marketing-IT-company-in-erode" },
    { name: "Content Creator", path: "/contentcreator/context-creator-IT-company-in-erode" },
    { name: "SEO Specialist", path: "/seospecialist/seo-specialist-IT-company-in-erode" },
    ...
    { name: "Social Media Handling", path: "/contentcreator/context-creator-IT-company-in-erode" },
    ...
    <footer className="footer">
      ...
      <ul>
        ...
        <div className="footer-col">
          <h3>Quick Links</h3>
          <ul>
            <li><a href="#home/web-design-IT-company-in-erode">Home</a></li>
            <li><a href="#how/web-design-IT-company-in-erode">How It Works</a></li>
            <li><a href="#portfolio/web-design-IT-company-in-erode">Portfolio</a></li>
            <li><a href="#career/web-design-IT-company-in-erode">Career</a></li>
            <li><a href="#about/web-design-IT-company-in-erode">About</a></li>
            <li><a href="#contact-web-design-IT-company-in-erode">Contact</a></li>
            <li><a href="#ourteam/web-design-IT-company-in-erode">Our Team</a></li>
