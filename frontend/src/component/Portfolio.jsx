...
export default function Portfolio() {
  return (
    <section id="portfolio/web-design-IT-company-in-erode" className="portfolio-section">
      <h2>Our Portfolio</h2>
