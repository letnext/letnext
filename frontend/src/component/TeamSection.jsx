...
const teamMembers = [
  ...
  {
    name: "Kavin Adithya S R",
    role: "Technical Trainer",
    description: "Transforming technical knowledge into actionable skills, while inspiring curiosity and growth in every learner.",
    img: "kavin.jpg",
  },
];
...
const TeamSection = () => {
  ...
  return (
    <section id="ourteam/web-design-IT-company-in-erode" className="team-wrapper">
      {/* Toggle Button */}
