  ...
  return (
    <Router>
      <Routes>
        ...
        />
        <Route
          path="/uiUxDesigner/uiux-design-IT-company-in-erode"
          element={<UiUxDesigner />}
        />
        <Route path="/testing/testing-IT-company-in-erode" element={<Testing />} />
        <Route
        ...
        <Route
          ...
          element={<SEOSpecialist />}
        />
        <Route
          path="/photographer/photograph-IT-company-in-erode"
          element={<Photographer />}
        />
        <Route
          path="/videographer/videograph-IT-company-in-erode"
        ...
        />
        <Route path="/iot/iot-IT-company-in-erode" element={<Iot />} />
        <Route
          path="/embbeded/embbeded-IT-company-in-erode"
          element={<Embbeded />}
        />
        ...
        <Route
          path="/fullstack/full-stack-IT-company-in-erode"
          element={<Fullstack />}
        />
        <Route path="/seo/seo-IT-company-in-erode" element={<Seo />} />
        <Route
          path="/datascientist/data-scientist-IT-company-in-erode"
          element={<Datascientist />}
        />
        <Route
          path="/cloudengineer/cloud-engineer-IT-company-in-erode"
          element={<Cloudengineer />}
        />
        <Route
          path="/mlengineer/ml-engineer-IT-company-in-erode"
          element={<Mlengineer />}
        />
        <Route path="/uiux/uiux-design-IT-company-in-erode" element={<Uiux />} />
        <Route
          path="/mobile/mobile-development-IT-company-in-erode"
          element={<Mobile />}
        />
        <Route path="/network/network-IT-company-in-erode" element={<Network />} />
        <Route
          path="/embedded/embedded-IT-company-in-erode"
          element={<Embedded />}
        />
        <Route
          path="/blockchain/blockchain-IT-company-in-erode"
          element={<Blockchain />}
        />
        <Route path="/excel/excel-IT-company-in-erode" element={<Excel />} />
      </Routes>
    </Router>
  );
}
